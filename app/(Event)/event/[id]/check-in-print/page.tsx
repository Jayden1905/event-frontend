...
import { QRCodeScanner } from '../check-in/(components)/qrReader'

export default function CheckInAndPrintPage() {
  ...
  return (
    <div className="flex flex-col gap-4">
      <h1 className="mb-2 text-3xl font-bold">Check-in Page And Print Badge</h1>
